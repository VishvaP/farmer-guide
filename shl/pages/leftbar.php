<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">Soil health card</a>
			</div>
                ...
                <div class="sidebar-nav navbar-collapse">
                   ...
                   <a href="?"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="add-course.php">Add location</a>
                                </li>
                                <li>
                 ...
                 <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Soil<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="add-subject.php">Add soil report</a>
                                </li>
                                <li>
                   ...
                   <li>
                            <a href="view.php"><i class="fa fa-bar-chart-o fa-fw"></i>View <span class="fa arrow"></span></a>
                  </li>      
                   <li>
